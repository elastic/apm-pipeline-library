...
class DownloadWithWgetStepTests extends ApmBasePipelineTest {
  def script
  ...
  void setUp() throws Exception {
    ...
    script = loadScript('vars/downloadWithWget.groovy')
  }
  ...
  @Test
  void test_without_wget_installed() throws Exception {
