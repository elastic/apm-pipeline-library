...
multibranchPipelineJob('observability-system-status-mbp') {
  primaryView('All')
  displayName('Job observability-system-status-mbp')
  description('Job observability-system-status-mbp description')
  ...
  branchSources {
    branchSource {
      source {
        github {
          id('observability-system-status-mbp') // IMPORTANT: use a constant and unique identifier
          credentialsId('2a9602aa-ab9f-4e52-baf3-b71ca88469c7-UserAndToken')
          repoOwner('elastic')
          repository('observability-system-status')
          repositoryUrl('https://github.com/elastic/observability-system-status.git')
          ...
          traits {
            ...
            cloneOptionTrait {
              extension {
                ...
                reference("/var/lib/jenkins//observability-system-status.git")
            ...
            notificationContextTrait {
              ...
              contextLabel('observability-system-status-mbp')
