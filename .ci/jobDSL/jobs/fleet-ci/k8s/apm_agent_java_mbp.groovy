...
multibranchPipelineJob('k8s-evaluation/apm-agent-java-mbp') {
  primaryView('All')
  ...
  branchSources {
    branchSource {
      source {
        github {
          id('k8s-evaluation/apm-agent-java-mbp') // IMPORTANT: use a constant and unique identifier
          credentialsId('2a9602aa-ab9f-4e52-baf3-b71ca88469c7-UserAndToken')
          repoOwner('v1v')
          repository('apm-agent-java')
          repositoryUrl('https://github.com/v1v/apm-agent-java.git')
          ...
          traits {
            ...
            cloneOptionTrait {
              extension {
                ...
                reference("/var/lib/jenkins/apm-agent-java.git")
