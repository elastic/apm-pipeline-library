...
pipeline {
  ...
  triggers {
    ...
    genericHeaderVariables: [
     ...
     regexpFilterExpression: '^(refs/tags/current|refs/heads/main/.+|refs/heads/main/.+)-comment$'
    )
  }
  stages {
    ...
    stage('Merge') {
      steps {
        echo 'There is a merge event. Then, it is required to evaluate what to do'
      }
    }
    stage('Comment') {
      steps {
        echo 'There is a valid comment event. Then, it is required to evaluate what to do'
      }
    }
  }
}
