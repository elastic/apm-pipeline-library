...
docker run -it -e DOCKER_USER -e DOCKER_PASSWORD -e DOCKER_REGISTRY -v /var/run/docker.sock:/var/run/docker.sock -v "$(pwd):/app -w /app docker.elastic.co/observability-ci/dind-buildx:20.10.14" """
